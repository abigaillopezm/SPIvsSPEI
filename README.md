...
| **01_DATA** | Contiene los datos originales e intermedios | *for_indices:* datos limpios y listos para proceder a la descarga de los datos 

*raw:* archivos originales (sin modificar nada)

 *SMN_limpios:* archivos intermedios de limpieza 
